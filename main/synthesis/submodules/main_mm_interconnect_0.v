...
module main_mm_interconnect_0 (
		...
		output wire [1:0]  button_enter_s1_address,                             //                               button_enter_s1.address
		output wire        button_enter_s1_write,                               //                                              .write
		input  wire [31:0] button_enter_s1_readdata,                            //                                              .readdata
		output wire [31:0] button_enter_s1_writedata,                           //                                              .writedata
		output wire        button_enter_s1_chipselect,                          //                                              .chipselect
		output wire [1:0]  button_exit_s1_address,                              //                                button_exit_s1.address
		input  wire [31:0] button_exit_s1_readdata,                             //                                              .readdata
		...
		output wire [1:0]  lcd_output_control_slave_address,                    //                      lcd_output_control_slave.address
		output wire        lcd_output_control_slave_write,                      //                                              .write
		output wire        lcd_output_control_slave_read,                       //                                              .read
		input  wire [7:0]  lcd_output_control_slave_readdata,                   //                                              .readdata
		output wire [7:0]  lcd_output_control_slave_writedata,                  //                                              .writedata
		output wire        lcd_output_control_slave_begintransfer,              //                                              .begintransfer
		output wire [1:0]  led_b_s1_address,                                    //                                      led_b_s1.address
		output wire        led_b_s1_write,                                      //                                              .write
		input  wire [31:0] led_b_s1_readdata,                                   //                                              .readdata
		output wire [31:0] led_b_s1_writedata,                                  //                                              .writedata
		output wire        led_b_s1_chipselect,                                 //                                              .chipselect
		...
		output wire [2:0]  uart_main_s1_address,                                //                                  uart_main_s1.address
		output wire        uart_main_s1_write,                                  //                                              .write
		output wire        uart_main_s1_read,                                   //                                              .read
		input  wire [15:0] uart_main_s1_readdata,                               //                                              .readdata
		output wire [15:0] uart_main_s1_writedata,                              //                                              .writedata
		output wire        uart_main_s1_begintransfer,                          //                                              .begintransfer
		output wire        uart_main_s1_chipselect                              //                                              .chipselect
	);
	...
	wire  [31:0] lcd_output_control_slave_agent_m0_readdata;                                            // lcd_output_control_slave_translator:uav_readdata -> lcd_output_control_slave_agent:m0_readdata
	wire         lcd_output_control_slave_agent_m0_waitrequest;                                         // lcd_output_control_slave_translator:uav_waitrequest -> lcd_output_control_slave_agent:m0_waitrequest
	wire         lcd_output_control_slave_agent_m0_debugaccess;                                         // lcd_output_control_slave_agent:m0_debugaccess -> lcd_output_control_slave_translator:uav_debugaccess
	wire  [15:0] lcd_output_control_slave_agent_m0_address;                                             // lcd_output_control_slave_agent:m0_address -> lcd_output_control_slave_translator:uav_address
	wire   [3:0] lcd_output_control_slave_agent_m0_byteenable;                                          // lcd_output_control_slave_agent:m0_byteenable -> lcd_output_control_slave_translator:uav_byteenable
	wire         lcd_output_control_slave_agent_m0_read;                                                // lcd_output_control_slave_agent:m0_read -> lcd_output_control_slave_translator:uav_read
	wire         lcd_output_control_slave_agent_m0_readdatavalid;                                       // lcd_output_control_slave_translator:uav_readdatavalid -> lcd_output_control_slave_agent:m0_readdatavalid
	wire         lcd_output_control_slave_agent_m0_lock;                                                // lcd_output_control_slave_agent:m0_lock -> lcd_output_control_slave_translator:uav_lock
	wire  [31:0] lcd_output_control_slave_agent_m0_writedata;                                           // lcd_output_control_slave_agent:m0_writedata -> lcd_output_control_slave_translator:uav_writedata
	wire         lcd_output_control_slave_agent_m0_write;                                               // lcd_output_control_slave_agent:m0_write -> lcd_output_control_slave_translator:uav_write
	wire   [2:0] lcd_output_control_slave_agent_m0_burstcount;                                          // lcd_output_control_slave_agent:m0_burstcount -> lcd_output_control_slave_translator:uav_burstcount
	wire         lcd_output_control_slave_agent_rf_source_valid;                                        // lcd_output_control_slave_agent:rf_source_valid -> lcd_output_control_slave_agent_rsp_fifo:in_valid
	wire  [94:0] lcd_output_control_slave_agent_rf_source_data;                                         // lcd_output_control_slave_agent:rf_source_data -> lcd_output_control_slave_agent_rsp_fifo:in_data
	wire         lcd_output_control_slave_agent_rf_source_ready;                                        // lcd_output_control_slave_agent_rsp_fifo:in_ready -> lcd_output_control_slave_agent:rf_source_ready
	wire         lcd_output_control_slave_agent_rf_source_startofpacket;                                // lcd_output_control_slave_agent:rf_source_startofpacket -> lcd_output_control_slave_agent_rsp_fifo:in_startofpacket
	wire         lcd_output_control_slave_agent_rf_source_endofpacket;                                  // lcd_output_control_slave_agent:rf_source_endofpacket -> lcd_output_control_slave_agent_rsp_fifo:in_endofpacket
	wire         lcd_output_control_slave_agent_rsp_fifo_out_valid;                                     // lcd_output_control_slave_agent_rsp_fifo:out_valid -> lcd_output_control_slave_agent:rf_sink_valid
	wire  [94:0] lcd_output_control_slave_agent_rsp_fifo_out_data;                                      // lcd_output_control_slave_agent_rsp_fifo:out_data -> lcd_output_control_slave_agent:rf_sink_data
	wire         lcd_output_control_slave_agent_rsp_fifo_out_ready;                                     // lcd_output_control_slave_agent:rf_sink_ready -> lcd_output_control_slave_agent_rsp_fifo:out_ready
	wire         lcd_output_control_slave_agent_rsp_fifo_out_startofpacket;                             // lcd_output_control_slave_agent_rsp_fifo:out_startofpacket -> lcd_output_control_slave_agent:rf_sink_startofpacket
	wire         lcd_output_control_slave_agent_rsp_fifo_out_endofpacket;                               // lcd_output_control_slave_agent_rsp_fifo:out_endofpacket -> lcd_output_control_slave_agent:rf_sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                                 // cmd_mux_001:src_valid -> lcd_output_control_slave_agent:cp_valid
	wire  [93:0] cmd_mux_001_src_data;                                                                  // cmd_mux_001:src_data -> lcd_output_control_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                                 // lcd_output_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire  [11:0] cmd_mux_001_src_channel;                                                               // cmd_mux_001:src_channel -> lcd_output_control_slave_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                         // cmd_mux_001:src_startofpacket -> lcd_output_control_slave_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                           // cmd_mux_001:src_endofpacket -> lcd_output_control_slave_agent:cp_endofpacket
	...
	wire  [93:0] cmd_mux_002_src_data;                                                                  // cmd_mux_002:src_data -> nios2_processor_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                                 // nios2_processor_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire  [11:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> nios2_processor_jtag_debug_module_agent:cp_channel
	...
	wire  [15:0] led_r_s1_agent_m0_address;                                                             // led_r_s1_agent:m0_address -> led_r_s1_translator:uav_address
	...
	wire  [94:0] led_r_s1_agent_rf_source_data;                                                         // led_r_s1_agent:rf_source_data -> led_r_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] led_r_s1_agent_rsp_fifo_out_data;                                                      // led_r_s1_agent_rsp_fifo:out_data -> led_r_s1_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_004_src_data;                                                                  // cmd_mux_004:src_data -> led_r_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                                 // led_r_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [11:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> led_r_s1_agent:cp_channel
	...
	wire  [31:0] button_exit_s1_agent_m0_readdata;                                                      // button_exit_s1_translator:uav_readdata -> button_exit_s1_agent:m0_readdata
	wire         button_exit_s1_agent_m0_waitrequest;                                                   // button_exit_s1_translator:uav_waitrequest -> button_exit_s1_agent:m0_waitrequest
	wire         button_exit_s1_agent_m0_debugaccess;                                                   // button_exit_s1_agent:m0_debugaccess -> button_exit_s1_translator:uav_debugaccess
	wire  [15:0] button_exit_s1_agent_m0_address;                                                       // button_exit_s1_agent:m0_address -> button_exit_s1_translator:uav_address
	wire   [3:0] button_exit_s1_agent_m0_byteenable;                                                    // button_exit_s1_agent:m0_byteenable -> button_exit_s1_translator:uav_byteenable
	wire         button_exit_s1_agent_m0_read;                                                          // button_exit_s1_agent:m0_read -> button_exit_s1_translator:uav_read
	wire         button_exit_s1_agent_m0_readdatavalid;                                                 // button_exit_s1_translator:uav_readdatavalid -> button_exit_s1_agent:m0_readdatavalid
	wire         button_exit_s1_agent_m0_lock;                                                          // button_exit_s1_agent:m0_lock -> button_exit_s1_translator:uav_lock
	wire  [31:0] button_exit_s1_agent_m0_writedata;                                                     // button_exit_s1_agent:m0_writedata -> button_exit_s1_translator:uav_writedata
	wire         button_exit_s1_agent_m0_write;                                                         // button_exit_s1_agent:m0_write -> button_exit_s1_translator:uav_write
	wire   [2:0] button_exit_s1_agent_m0_burstcount;                                                    // button_exit_s1_agent:m0_burstcount -> button_exit_s1_translator:uav_burstcount
	wire         button_exit_s1_agent_rf_source_valid;                                                  // button_exit_s1_agent:rf_source_valid -> button_exit_s1_agent_rsp_fifo:in_valid
	wire  [94:0] button_exit_s1_agent_rf_source_data;                                                   // button_exit_s1_agent:rf_source_data -> button_exit_s1_agent_rsp_fifo:in_data
	wire         button_exit_s1_agent_rf_source_ready;                                                  // button_exit_s1_agent_rsp_fifo:in_ready -> button_exit_s1_agent:rf_source_ready
	wire         button_exit_s1_agent_rf_source_startofpacket;                                          // button_exit_s1_agent:rf_source_startofpacket -> button_exit_s1_agent_rsp_fifo:in_startofpacket
	wire         button_exit_s1_agent_rf_source_endofpacket;                                            // button_exit_s1_agent:rf_source_endofpacket -> button_exit_s1_agent_rsp_fifo:in_endofpacket
	wire         button_exit_s1_agent_rsp_fifo_out_valid;                                               // button_exit_s1_agent_rsp_fifo:out_valid -> button_exit_s1_agent:rf_sink_valid
	wire  [94:0] button_exit_s1_agent_rsp_fifo_out_data;                                                // button_exit_s1_agent_rsp_fifo:out_data -> button_exit_s1_agent:rf_sink_data
	wire         button_exit_s1_agent_rsp_fifo_out_ready;                                               // button_exit_s1_agent:rf_sink_ready -> button_exit_s1_agent_rsp_fifo:out_ready
	wire         button_exit_s1_agent_rsp_fifo_out_startofpacket;                                       // button_exit_s1_agent_rsp_fifo:out_startofpacket -> button_exit_s1_agent:rf_sink_startofpacket
	wire         button_exit_s1_agent_rsp_fifo_out_endofpacket;                                         // button_exit_s1_agent_rsp_fifo:out_endofpacket -> button_exit_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                                 // cmd_mux_005:src_valid -> button_exit_s1_agent:cp_valid
	wire  [93:0] cmd_mux_005_src_data;                                                                  // cmd_mux_005:src_data -> button_exit_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                                 // button_exit_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [11:0] cmd_mux_005_src_channel;                                                               // cmd_mux_005:src_channel -> button_exit_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                         // cmd_mux_005:src_startofpacket -> button_exit_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                           // cmd_mux_005:src_endofpacket -> button_exit_s1_agent:cp_endofpacket
	wire  [31:0] button_enter_s1_agent_m0_readdata;                                                     // button_enter_s1_translator:uav_readdata -> button_enter_s1_agent:m0_readdata
	wire         button_enter_s1_agent_m0_waitrequest;                                                  // button_enter_s1_translator:uav_waitrequest -> button_enter_s1_agent:m0_waitrequest
	wire         button_enter_s1_agent_m0_debugaccess;                                                  // button_enter_s1_agent:m0_debugaccess -> button_enter_s1_translator:uav_debugaccess
	wire  [15:0] button_enter_s1_agent_m0_address;                                                      // button_enter_s1_agent:m0_address -> button_enter_s1_translator:uav_address
	wire   [3:0] button_enter_s1_agent_m0_byteenable;                                                   // button_enter_s1_agent:m0_byteenable -> button_enter_s1_translator:uav_byteenable
	wire         button_enter_s1_agent_m0_read;                                                         // button_enter_s1_agent:m0_read -> button_enter_s1_translator:uav_read
	wire         button_enter_s1_agent_m0_readdatavalid;                                                // button_enter_s1_translator:uav_readdatavalid -> button_enter_s1_agent:m0_readdatavalid
	wire         button_enter_s1_agent_m0_lock;                                                         // button_enter_s1_agent:m0_lock -> button_enter_s1_translator:uav_lock
	wire  [31:0] button_enter_s1_agent_m0_writedata;                                                    // button_enter_s1_agent:m0_writedata -> button_enter_s1_translator:uav_writedata
	wire         button_enter_s1_agent_m0_write;                                                        // button_enter_s1_agent:m0_write -> button_enter_s1_translator:uav_write
	wire   [2:0] button_enter_s1_agent_m0_burstcount;                                                   // button_enter_s1_agent:m0_burstcount -> button_enter_s1_translator:uav_burstcount
	wire         button_enter_s1_agent_rf_source_valid;                                                 // button_enter_s1_agent:rf_source_valid -> button_enter_s1_agent_rsp_fifo:in_valid
	wire  [94:0] button_enter_s1_agent_rf_source_data;                                                  // button_enter_s1_agent:rf_source_data -> button_enter_s1_agent_rsp_fifo:in_data
	wire         button_enter_s1_agent_rf_source_ready;                                                 // button_enter_s1_agent_rsp_fifo:in_ready -> button_enter_s1_agent:rf_source_ready
	wire         button_enter_s1_agent_rf_source_startofpacket;                                         // button_enter_s1_agent:rf_source_startofpacket -> button_enter_s1_agent_rsp_fifo:in_startofpacket
	wire         button_enter_s1_agent_rf_source_endofpacket;                                           // button_enter_s1_agent:rf_source_endofpacket -> button_enter_s1_agent_rsp_fifo:in_endofpacket
	wire         button_enter_s1_agent_rsp_fifo_out_valid;                                              // button_enter_s1_agent_rsp_fifo:out_valid -> button_enter_s1_agent:rf_sink_valid
	wire  [94:0] button_enter_s1_agent_rsp_fifo_out_data;                                               // button_enter_s1_agent_rsp_fifo:out_data -> button_enter_s1_agent:rf_sink_data
	wire         button_enter_s1_agent_rsp_fifo_out_ready;                                              // button_enter_s1_agent:rf_sink_ready -> button_enter_s1_agent_rsp_fifo:out_ready
	wire         button_enter_s1_agent_rsp_fifo_out_startofpacket;                                      // button_enter_s1_agent_rsp_fifo:out_startofpacket -> button_enter_s1_agent:rf_sink_startofpacket
	wire         button_enter_s1_agent_rsp_fifo_out_endofpacket;                                        // button_enter_s1_agent_rsp_fifo:out_endofpacket -> button_enter_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_006_src_valid;                                                                 // cmd_mux_006:src_valid -> button_enter_s1_agent:cp_valid
	wire  [93:0] cmd_mux_006_src_data;                                                                  // cmd_mux_006:src_data -> button_enter_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                                 // button_enter_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [11:0] cmd_mux_006_src_channel;                                                               // cmd_mux_006:src_channel -> button_enter_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                         // cmd_mux_006:src_startofpacket -> button_enter_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                           // cmd_mux_006:src_endofpacket -> button_enter_s1_agent:cp_endofpacket
	...
	wire  [15:0] button_down_s1_agent_m0_address;                                                       // button_down_s1_agent:m0_address -> button_down_s1_translator:uav_address
	...
	wire  [94:0] button_down_s1_agent_rf_source_data;                                                   // button_down_s1_agent:rf_source_data -> button_down_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] button_down_s1_agent_rsp_fifo_out_data;                                                // button_down_s1_agent_rsp_fifo:out_data -> button_down_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                                 // cmd_mux_007:src_valid -> button_down_s1_agent:cp_valid
	wire  [93:0] cmd_mux_007_src_data;                                                                  // cmd_mux_007:src_data -> button_down_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                                 // button_down_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [11:0] cmd_mux_007_src_channel;                                                               // cmd_mux_007:src_channel -> button_down_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                         // cmd_mux_007:src_startofpacket -> button_down_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                           // cmd_mux_007:src_endofpacket -> button_down_s1_agent:cp_endofpacket
	wire  [31:0] led_b_s1_agent_m0_readdata;                                                            // led_b_s1_translator:uav_readdata -> led_b_s1_agent:m0_readdata
	wire         led_b_s1_agent_m0_waitrequest;                                                         // led_b_s1_translator:uav_waitrequest -> led_b_s1_agent:m0_waitrequest
	wire         led_b_s1_agent_m0_debugaccess;                                                         // led_b_s1_agent:m0_debugaccess -> led_b_s1_translator:uav_debugaccess
	wire  [15:0] led_b_s1_agent_m0_address;                                                             // led_b_s1_agent:m0_address -> led_b_s1_translator:uav_address
	wire   [3:0] led_b_s1_agent_m0_byteenable;                                                          // led_b_s1_agent:m0_byteenable -> led_b_s1_translator:uav_byteenable
	wire         led_b_s1_agent_m0_read;                                                                // led_b_s1_agent:m0_read -> led_b_s1_translator:uav_read
	wire         led_b_s1_agent_m0_readdatavalid;                                                       // led_b_s1_translator:uav_readdatavalid -> led_b_s1_agent:m0_readdatavalid
	wire         led_b_s1_agent_m0_lock;                                                                // led_b_s1_agent:m0_lock -> led_b_s1_translator:uav_lock
	wire  [31:0] led_b_s1_agent_m0_writedata;                                                           // led_b_s1_agent:m0_writedata -> led_b_s1_translator:uav_writedata
	wire         led_b_s1_agent_m0_write;                                                               // led_b_s1_agent:m0_write -> led_b_s1_translator:uav_write
	wire   [2:0] led_b_s1_agent_m0_burstcount;                                                          // led_b_s1_agent:m0_burstcount -> led_b_s1_translator:uav_burstcount
	wire         led_b_s1_agent_rf_source_valid;                                                        // led_b_s1_agent:rf_source_valid -> led_b_s1_agent_rsp_fifo:in_valid
	wire  [94:0] led_b_s1_agent_rf_source_data;                                                         // led_b_s1_agent:rf_source_data -> led_b_s1_agent_rsp_fifo:in_data
	wire         led_b_s1_agent_rf_source_ready;                                                        // led_b_s1_agent_rsp_fifo:in_ready -> led_b_s1_agent:rf_source_ready
	wire         led_b_s1_agent_rf_source_startofpacket;                                                // led_b_s1_agent:rf_source_startofpacket -> led_b_s1_agent_rsp_fifo:in_startofpacket
	wire         led_b_s1_agent_rf_source_endofpacket;                                                  // led_b_s1_agent:rf_source_endofpacket -> led_b_s1_agent_rsp_fifo:in_endofpacket
	wire         led_b_s1_agent_rsp_fifo_out_valid;                                                     // led_b_s1_agent_rsp_fifo:out_valid -> led_b_s1_agent:rf_sink_valid
	wire  [94:0] led_b_s1_agent_rsp_fifo_out_data;                                                      // led_b_s1_agent_rsp_fifo:out_data -> led_b_s1_agent:rf_sink_data
	wire         led_b_s1_agent_rsp_fifo_out_ready;                                                     // led_b_s1_agent:rf_sink_ready -> led_b_s1_agent_rsp_fifo:out_ready
	wire         led_b_s1_agent_rsp_fifo_out_startofpacket;                                             // led_b_s1_agent_rsp_fifo:out_startofpacket -> led_b_s1_agent:rf_sink_startofpacket
	wire         led_b_s1_agent_rsp_fifo_out_endofpacket;                                               // led_b_s1_agent_rsp_fifo:out_endofpacket -> led_b_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                                 // cmd_mux_008:src_valid -> led_b_s1_agent:cp_valid
	wire  [93:0] cmd_mux_008_src_data;                                                                  // cmd_mux_008:src_data -> led_b_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                                 // led_b_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [11:0] cmd_mux_008_src_channel;                                                               // cmd_mux_008:src_channel -> led_b_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                         // cmd_mux_008:src_startofpacket -> led_b_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                           // cmd_mux_008:src_endofpacket -> led_b_s1_agent:cp_endofpacket
	...
	wire  [15:0] led_g_s1_agent_m0_address;                                                             // led_g_s1_agent:m0_address -> led_g_s1_translator:uav_address
	...
	wire  [94:0] led_g_s1_agent_rf_source_data;                                                         // led_g_s1_agent:rf_source_data -> led_g_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] led_g_s1_agent_rsp_fifo_out_data;                                                      // led_g_s1_agent_rsp_fifo:out_data -> led_g_s1_agent:rf_sink_data
	...
	wire         cmd_mux_009_src_valid;                                                                 // cmd_mux_009:src_valid -> led_g_s1_agent:cp_valid
	wire  [93:0] cmd_mux_009_src_data;                                                                  // cmd_mux_009:src_data -> led_g_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                                 // led_g_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [11:0] cmd_mux_009_src_channel;                                                               // cmd_mux_009:src_channel -> led_g_s1_agent:cp_channel
	wire         cmd_mux_009_src_startofpacket;                                                         // cmd_mux_009:src_startofpacket -> led_g_s1_agent:cp_startofpacket
	wire         cmd_mux_009_src_endofpacket;                                                           // cmd_mux_009:src_endofpacket -> led_g_s1_agent:cp_endofpacket
	wire  [31:0] uart_main_s1_agent_m0_readdata;                                                        // uart_main_s1_translator:uav_readdata -> uart_main_s1_agent:m0_readdata
	wire         uart_main_s1_agent_m0_waitrequest;                                                     // uart_main_s1_translator:uav_waitrequest -> uart_main_s1_agent:m0_waitrequest
	wire         uart_main_s1_agent_m0_debugaccess;                                                     // uart_main_s1_agent:m0_debugaccess -> uart_main_s1_translator:uav_debugaccess
	wire  [15:0] uart_main_s1_agent_m0_address;                                                         // uart_main_s1_agent:m0_address -> uart_main_s1_translator:uav_address
	wire   [3:0] uart_main_s1_agent_m0_byteenable;                                                      // uart_main_s1_agent:m0_byteenable -> uart_main_s1_translator:uav_byteenable
	wire         uart_main_s1_agent_m0_read;                                                            // uart_main_s1_agent:m0_read -> uart_main_s1_translator:uav_read
	wire         uart_main_s1_agent_m0_readdatavalid;                                                   // uart_main_s1_translator:uav_readdatavalid -> uart_main_s1_agent:m0_readdatavalid
	wire         uart_main_s1_agent_m0_lock;                                                            // uart_main_s1_agent:m0_lock -> uart_main_s1_translator:uav_lock
	wire  [31:0] uart_main_s1_agent_m0_writedata;                                                       // uart_main_s1_agent:m0_writedata -> uart_main_s1_translator:uav_writedata
	wire         uart_main_s1_agent_m0_write;                                                           // uart_main_s1_agent:m0_write -> uart_main_s1_translator:uav_write
	wire   [2:0] uart_main_s1_agent_m0_burstcount;                                                      // uart_main_s1_agent:m0_burstcount -> uart_main_s1_translator:uav_burstcount
	wire         uart_main_s1_agent_rf_source_valid;                                                    // uart_main_s1_agent:rf_source_valid -> uart_main_s1_agent_rsp_fifo:in_valid
	wire  [94:0] uart_main_s1_agent_rf_source_data;                                                     // uart_main_s1_agent:rf_source_data -> uart_main_s1_agent_rsp_fifo:in_data
	wire         uart_main_s1_agent_rf_source_ready;                                                    // uart_main_s1_agent_rsp_fifo:in_ready -> uart_main_s1_agent:rf_source_ready
	wire         uart_main_s1_agent_rf_source_startofpacket;                                            // uart_main_s1_agent:rf_source_startofpacket -> uart_main_s1_agent_rsp_fifo:in_startofpacket
	wire         uart_main_s1_agent_rf_source_endofpacket;                                              // uart_main_s1_agent:rf_source_endofpacket -> uart_main_s1_agent_rsp_fifo:in_endofpacket
	wire         uart_main_s1_agent_rsp_fifo_out_valid;                                                 // uart_main_s1_agent_rsp_fifo:out_valid -> uart_main_s1_agent:rf_sink_valid
	wire  [94:0] uart_main_s1_agent_rsp_fifo_out_data;                                                  // uart_main_s1_agent_rsp_fifo:out_data -> uart_main_s1_agent:rf_sink_data
	wire         uart_main_s1_agent_rsp_fifo_out_ready;                                                 // uart_main_s1_agent:rf_sink_ready -> uart_main_s1_agent_rsp_fifo:out_ready
	wire         uart_main_s1_agent_rsp_fifo_out_startofpacket;                                         // uart_main_s1_agent_rsp_fifo:out_startofpacket -> uart_main_s1_agent:rf_sink_startofpacket
	wire         uart_main_s1_agent_rsp_fifo_out_endofpacket;                                           // uart_main_s1_agent_rsp_fifo:out_endofpacket -> uart_main_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_010_src_valid;                                                                 // cmd_mux_010:src_valid -> uart_main_s1_agent:cp_valid
	wire  [93:0] cmd_mux_010_src_data;                                                                  // cmd_mux_010:src_data -> uart_main_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                                 // uart_main_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [11:0] cmd_mux_010_src_channel;                                                               // cmd_mux_010:src_channel -> uart_main_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                                         // cmd_mux_010:src_startofpacket -> uart_main_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                                           // cmd_mux_010:src_endofpacket -> uart_main_s1_agent:cp_endofpacket
	...
	wire  [15:0] button_up_s1_agent_m0_address;                                                         // button_up_s1_agent:m0_address -> button_up_s1_translator:uav_address
	...
	wire  [94:0] button_up_s1_agent_rf_source_data;                                                     // button_up_s1_agent:rf_source_data -> button_up_s1_agent_rsp_fifo:in_data
	...
	wire  [94:0] button_up_s1_agent_rsp_fifo_out_data;                                                  // button_up_s1_agent_rsp_fifo:out_data -> button_up_s1_agent:rf_sink_data
	...
	wire         cmd_mux_011_src_valid;                                                                 // cmd_mux_011:src_valid -> button_up_s1_agent:cp_valid
	wire  [93:0] cmd_mux_011_src_data;                                                                  // cmd_mux_011:src_data -> button_up_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                                 // button_up_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [11:0] cmd_mux_011_src_channel;                                                               // cmd_mux_011:src_channel -> button_up_s1_agent:cp_channel
	wire         cmd_mux_011_src_startofpacket;                                                         // cmd_mux_011:src_startofpacket -> button_up_s1_agent:cp_startofpacket
	wire         cmd_mux_011_src_endofpacket;                                                           // cmd_mux_011:src_endofpacket -> button_up_s1_agent:cp_endofpacket
	...
	wire         lcd_output_control_slave_agent_rp_valid;                                               // lcd_output_control_slave_agent:rp_valid -> router_003:sink_valid
	wire  [93:0] lcd_output_control_slave_agent_rp_data;                                                // lcd_output_control_slave_agent:rp_data -> router_003:sink_data
	wire         lcd_output_control_slave_agent_rp_ready;                                               // router_003:sink_ready -> lcd_output_control_slave_agent:rp_ready
	wire         lcd_output_control_slave_agent_rp_startofpacket;                                       // lcd_output_control_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         lcd_output_control_slave_agent_rp_endofpacket;                                         // lcd_output_control_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [93:0] nios2_processor_jtag_debug_module_agent_rp_data;                                       // nios2_processor_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [93:0] led_r_s1_agent_rp_data;                                                                // led_r_s1_agent:rp_data -> router_006:sink_data
	...
	wire         button_exit_s1_agent_rp_valid;                                                         // button_exit_s1_agent:rp_valid -> router_007:sink_valid
	wire  [93:0] button_exit_s1_agent_rp_data;                                                          // button_exit_s1_agent:rp_data -> router_007:sink_data
	wire         button_exit_s1_agent_rp_ready;                                                         // router_007:sink_ready -> button_exit_s1_agent:rp_ready
	wire         button_exit_s1_agent_rp_startofpacket;                                                 // button_exit_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         button_exit_s1_agent_rp_endofpacket;                                                   // button_exit_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         button_enter_s1_agent_rp_valid;                                                        // button_enter_s1_agent:rp_valid -> router_008:sink_valid
	wire  [93:0] button_enter_s1_agent_rp_data;                                                         // button_enter_s1_agent:rp_data -> router_008:sink_data
	wire         button_enter_s1_agent_rp_ready;                                                        // router_008:sink_ready -> button_enter_s1_agent:rp_ready
	wire         button_enter_s1_agent_rp_startofpacket;                                                // button_enter_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         button_enter_s1_agent_rp_endofpacket;                                                  // button_enter_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         button_down_s1_agent_rp_valid;                                                         // button_down_s1_agent:rp_valid -> router_009:sink_valid
	wire  [93:0] button_down_s1_agent_rp_data;                                                          // button_down_s1_agent:rp_data -> router_009:sink_data
	wire         button_down_s1_agent_rp_ready;                                                         // router_009:sink_ready -> button_down_s1_agent:rp_ready
	wire         button_down_s1_agent_rp_startofpacket;                                                 // button_down_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         button_down_s1_agent_rp_endofpacket;                                                   // button_down_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         led_b_s1_agent_rp_valid;                                                               // led_b_s1_agent:rp_valid -> router_010:sink_valid
	wire  [93:0] led_b_s1_agent_rp_data;                                                                // led_b_s1_agent:rp_data -> router_010:sink_data
	wire         led_b_s1_agent_rp_ready;                                                               // router_010:sink_ready -> led_b_s1_agent:rp_ready
	wire         led_b_s1_agent_rp_startofpacket;                                                       // led_b_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         led_b_s1_agent_rp_endofpacket;                                                         // led_b_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         led_g_s1_agent_rp_valid;                                                               // led_g_s1_agent:rp_valid -> router_011:sink_valid
	wire  [93:0] led_g_s1_agent_rp_data;                                                                // led_g_s1_agent:rp_data -> router_011:sink_data
	wire         led_g_s1_agent_rp_ready;                                                               // router_011:sink_ready -> led_g_s1_agent:rp_ready
	wire         led_g_s1_agent_rp_startofpacket;                                                       // led_g_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire         led_g_s1_agent_rp_endofpacket;                                                         // led_g_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire         uart_main_s1_agent_rp_valid;                                                           // uart_main_s1_agent:rp_valid -> router_012:sink_valid
	wire  [93:0] uart_main_s1_agent_rp_data;                                                            // uart_main_s1_agent:rp_data -> router_012:sink_data
	wire         uart_main_s1_agent_rp_ready;                                                           // router_012:sink_ready -> uart_main_s1_agent:rp_ready
	wire         uart_main_s1_agent_rp_startofpacket;                                                   // uart_main_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire         uart_main_s1_agent_rp_endofpacket;                                                     // uart_main_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire         button_up_s1_agent_rp_valid;                                                           // button_up_s1_agent:rp_valid -> router_013:sink_valid
	wire  [93:0] button_up_s1_agent_rp_data;                                                            // button_up_s1_agent:rp_data -> router_013:sink_data
	wire         button_up_s1_agent_rp_ready;                                                           // router_013:sink_ready -> button_up_s1_agent:rp_ready
	wire         button_up_s1_agent_rp_startofpacket;                                                   // button_up_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire         button_up_s1_agent_rp_endofpacket;                                                     // button_up_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [93:0] cmd_demux_001_src7_data;                                                               // cmd_demux_001:src7_data -> cmd_mux_007:sink1_data
	...
	wire  [93:0] cmd_demux_001_src8_data;                                                               // cmd_demux_001:src8_data -> cmd_mux_008:sink1_data
	...
	wire  [93:0] cmd_demux_001_src9_data;                                                               // cmd_demux_001:src9_data -> cmd_mux_009:sink1_data
	...
	wire  [93:0] cmd_demux_001_src10_data;                                                              // cmd_demux_001:src10_data -> cmd_mux_010:sink1_data
	...
	wire  [93:0] cmd_demux_001_src11_data;                                                              // cmd_demux_001:src11_data -> cmd_mux_011:sink1_data
	...
	wire  [93:0] rsp_demux_007_src1_data;                                                               // rsp_demux_007:src1_data -> rsp_mux_001:sink7_data
	...
	wire  [93:0] rsp_demux_008_src1_data;                                                               // rsp_demux_008:src1_data -> rsp_mux_001:sink8_data
	...
	wire  [93:0] rsp_demux_009_src1_data;                                                               // rsp_demux_009:src1_data -> rsp_mux_001:sink9_data
	...
	wire  [93:0] rsp_demux_010_src1_data;                                                               // rsp_demux_010:src1_data -> rsp_mux_001:sink10_data
	...
	wire  [93:0] rsp_demux_011_src1_data;                                                               // rsp_demux_011:src1_data -> rsp_mux_001:sink11_data
	...
	wire         lcd_output_control_slave_agent_rdata_fifo_src_valid;                                   // lcd_output_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] lcd_output_control_slave_agent_rdata_fifo_src_data;                                    // lcd_output_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         lcd_output_control_slave_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_001:in_0_ready -> lcd_output_control_slave_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                     // avalon_st_adapter_001:out_0_valid -> lcd_output_control_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                      // avalon_st_adapter_001:out_0_data -> lcd_output_control_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                     // lcd_output_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                     // avalon_st_adapter_001:out_0_error -> lcd_output_control_slave_agent:rdata_fifo_sink_error
	...
	wire         button_exit_s1_agent_rdata_fifo_src_valid;                                             // button_exit_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] button_exit_s1_agent_rdata_fifo_src_data;                                              // button_exit_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         button_exit_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_005:in_0_ready -> button_exit_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                     // avalon_st_adapter_005:out_0_valid -> button_exit_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                      // avalon_st_adapter_005:out_0_data -> button_exit_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                     // button_exit_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                     // avalon_st_adapter_005:out_0_error -> button_exit_s1_agent:rdata_fifo_sink_error
	wire         button_enter_s1_agent_rdata_fifo_src_valid;                                            // button_enter_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] button_enter_s1_agent_rdata_fifo_src_data;                                             // button_enter_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         button_enter_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> button_enter_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                     // avalon_st_adapter_006:out_0_valid -> button_enter_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                      // avalon_st_adapter_006:out_0_data -> button_enter_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                     // button_enter_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                     // avalon_st_adapter_006:out_0_error -> button_enter_s1_agent:rdata_fifo_sink_error
	wire         button_down_s1_agent_rdata_fifo_src_valid;                                             // button_down_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] button_down_s1_agent_rdata_fifo_src_data;                                              // button_down_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         button_down_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_007:in_0_ready -> button_down_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                     // avalon_st_adapter_007:out_0_valid -> button_down_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                      // avalon_st_adapter_007:out_0_data -> button_down_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                     // button_down_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                     // avalon_st_adapter_007:out_0_error -> button_down_s1_agent:rdata_fifo_sink_error
	wire         led_b_s1_agent_rdata_fifo_src_valid;                                                   // led_b_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] led_b_s1_agent_rdata_fifo_src_data;                                                    // led_b_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         led_b_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_008:in_0_ready -> led_b_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                     // avalon_st_adapter_008:out_0_valid -> led_b_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                      // avalon_st_adapter_008:out_0_data -> led_b_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                     // led_b_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                     // avalon_st_adapter_008:out_0_error -> led_b_s1_agent:rdata_fifo_sink_error
	wire         led_g_s1_agent_rdata_fifo_src_valid;                                                   // led_g_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire  [33:0] led_g_s1_agent_rdata_fifo_src_data;                                                    // led_g_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire         led_g_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter_009:in_0_ready -> led_g_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_009_out_0_valid;                                                     // avalon_st_adapter_009:out_0_valid -> led_g_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_009_out_0_data;                                                      // avalon_st_adapter_009:out_0_data -> led_g_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_009_out_0_ready;                                                     // led_g_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire   [0:0] avalon_st_adapter_009_out_0_error;                                                     // avalon_st_adapter_009:out_0_error -> led_g_s1_agent:rdata_fifo_sink_error
	wire         uart_main_s1_agent_rdata_fifo_src_valid;                                               // uart_main_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] uart_main_s1_agent_rdata_fifo_src_data;                                                // uart_main_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire         uart_main_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_010:in_0_ready -> uart_main_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_010_out_0_valid;                                                     // avalon_st_adapter_010:out_0_valid -> uart_main_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_010_out_0_data;                                                      // avalon_st_adapter_010:out_0_data -> uart_main_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_010_out_0_ready;                                                     // uart_main_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire   [0:0] avalon_st_adapter_010_out_0_error;                                                     // avalon_st_adapter_010:out_0_error -> uart_main_s1_agent:rdata_fifo_sink_error
	wire         button_up_s1_agent_rdata_fifo_src_valid;                                               // button_up_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire  [33:0] button_up_s1_agent_rdata_fifo_src_data;                                                // button_up_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire         button_up_s1_agent_rdata_fifo_src_ready;                                               // avalon_st_adapter_011:in_0_ready -> button_up_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_011_out_0_valid;                                                     // avalon_st_adapter_011:out_0_valid -> button_up_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_011_out_0_data;                                                      // avalon_st_adapter_011:out_0_data -> button_up_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_011_out_0_ready;                                                     // button_up_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire   [0:0] avalon_st_adapter_011_out_0_error;                                                     // avalon_st_adapter_011:out_0_error -> button_up_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (nios2_processor_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (lcd_output_control_slave_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (lcd_output_control_slave_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (lcd_output_control_slave_agent_m0_read),              //                         .read
		.uav_write              (lcd_output_control_slave_agent_m0_write),             //                         .write
		.uav_waitrequest        (lcd_output_control_slave_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (lcd_output_control_slave_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (lcd_output_control_slave_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (lcd_output_control_slave_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (lcd_output_control_slave_agent_m0_writedata),         //                         .writedata
		.uav_lock               (lcd_output_control_slave_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (lcd_output_control_slave_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (lcd_output_control_slave_address),                    //      avalon_anti_slave_0.address
		.av_write               (lcd_output_control_slave_write),                      //                         .write
		.av_read                (lcd_output_control_slave_read),                       //                         .read
		.av_readdata            (lcd_output_control_slave_readdata),                   //                         .readdata
		.av_writedata           (lcd_output_control_slave_writedata),                  //                         .writedata
		.av_begintransfer       (lcd_output_control_slave_begintransfer),              //                         .begintransfer
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
		.av_byteenable          (),                                                    //              (terminated)
		.av_readdatavalid       (1'b0),                                                //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (nios2_processor_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (button_exit_s1_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (button_exit_s1_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (button_exit_s1_agent_m0_read),                        //                         .read
		.uav_write              (button_exit_s1_agent_m0_write),                       //                         .write
		.uav_waitrequest        (button_exit_s1_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (button_exit_s1_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (button_exit_s1_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (button_exit_s1_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (button_exit_s1_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (button_exit_s1_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (button_exit_s1_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (button_exit_s1_address),                              //      avalon_anti_slave_0.address
		.av_readdata            (button_exit_s1_readdata),                             //                         .readdata
		.av_write               (),                                                    //              (terminated)
		.av_read                (),                                                    //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (nios2_processor_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (button_enter_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (button_enter_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (button_enter_s1_agent_m0_read),                       //                         .read
		.uav_write              (button_enter_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (button_enter_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (button_enter_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (button_enter_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (button_enter_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (button_enter_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (button_enter_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (button_enter_s1_agent_m0_debugaccess),                //                         .debugaccess
		.av_address             (button_enter_s1_address),                             //      avalon_anti_slave_0.address
		.av_write               (button_enter_s1_write),                               //                         .write
		.av_readdata            (button_enter_s1_readdata),                            //                         .readdata
		.av_writedata           (button_enter_s1_writedata),                           //                         .writedata
		.av_chipselect          (button_enter_s1_chipselect),                          //                         .chipselect
		.av_read                (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (nios2_processor_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_b_s1_agent_m0_address),                           // avalon_universal_slave_0.address
		.uav_burstcount         (led_b_s1_agent_m0_burstcount),                        //                         .burstcount
		.uav_read               (led_b_s1_agent_m0_read),                              //                         .read
		.uav_write              (led_b_s1_agent_m0_write),                             //                         .write
		.uav_waitrequest        (led_b_s1_agent_m0_waitrequest),                       //                         .waitrequest
		.uav_readdatavalid      (led_b_s1_agent_m0_readdatavalid),                     //                         .readdatavalid
		.uav_byteenable         (led_b_s1_agent_m0_byteenable),                        //                         .byteenable
		.uav_readdata           (led_b_s1_agent_m0_readdata),                          //                         .readdata
		.uav_writedata          (led_b_s1_agent_m0_writedata),                         //                         .writedata
		.uav_lock               (led_b_s1_agent_m0_lock),                              //                         .lock
		.uav_debugaccess        (led_b_s1_agent_m0_debugaccess),                       //                         .debugaccess
		.av_address             (led_b_s1_address),                                    //      avalon_anti_slave_0.address
		.av_write               (led_b_s1_write),                                      //                         .write
		.av_readdata            (led_b_s1_readdata),                                   //                         .readdata
		.av_writedata           (led_b_s1_writedata),                                  //                         .writedata
		.av_chipselect          (led_b_s1_chipselect),                                 //                         .chipselect
		.av_read                (),                                                    //              (terminated)
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                       //                      clk.clk
		.reset                  (nios2_processor_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (uart_main_s1_agent_m0_address),                       // avalon_universal_slave_0.address
		.uav_burstcount         (uart_main_s1_agent_m0_burstcount),                    //                         .burstcount
		.uav_read               (uart_main_s1_agent_m0_read),                          //                         .read
		.uav_write              (uart_main_s1_agent_m0_write),                         //                         .write
		.uav_waitrequest        (uart_main_s1_agent_m0_waitrequest),                   //                         .waitrequest
		.uav_readdatavalid      (uart_main_s1_agent_m0_readdatavalid),                 //                         .readdatavalid
		.uav_byteenable         (uart_main_s1_agent_m0_byteenable),                    //                         .byteenable
		.uav_readdata           (uart_main_s1_agent_m0_readdata),                      //                         .readdata
		.uav_writedata          (uart_main_s1_agent_m0_writedata),                     //                         .writedata
		.uav_lock               (uart_main_s1_agent_m0_lock),                          //                         .lock
		.uav_debugaccess        (uart_main_s1_agent_m0_debugaccess),                   //                         .debugaccess
		.av_address             (uart_main_s1_address),                                //      avalon_anti_slave_0.address
		.av_write               (uart_main_s1_write),                                  //                         .write
		.av_read                (uart_main_s1_read),                                   //                         .read
		.av_readdata            (uart_main_s1_readdata),                               //                         .readdata
		.av_writedata           (uart_main_s1_writedata),                              //                         .writedata
		.av_begintransfer       (uart_main_s1_begintransfer),                          //                         .begintransfer
		.av_chipselect          (uart_main_s1_chipselect),                             //                         .chipselect
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
		.av_byteenable          (),                                                    //              (terminated)
		.av_readdatavalid       (1'b0),                                                //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) lcd_output_control_slave_agent (
		.clk                     (clk_0_clk_clk),                                             //             clk.clk
		.reset                   (nios2_processor_reset_n_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (lcd_output_control_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (lcd_output_control_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (lcd_output_control_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (lcd_output_control_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (lcd_output_control_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (lcd_output_control_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (lcd_output_control_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (lcd_output_control_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (lcd_output_control_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (lcd_output_control_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (lcd_output_control_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (lcd_output_control_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (lcd_output_control_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (lcd_output_control_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (lcd_output_control_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (lcd_output_control_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (lcd_output_control_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (lcd_output_control_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (lcd_output_control_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (lcd_output_control_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (lcd_output_control_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (lcd_output_control_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (lcd_output_control_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (lcd_output_control_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (lcd_output_control_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (lcd_output_control_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                         //                .error
		.rdata_fifo_src_ready    (lcd_output_control_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lcd_output_control_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (lcd_output_control_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lcd_output_control_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                             //       clk.clk
		.reset             (nios2_processor_reset_n_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (lcd_output_control_slave_agent_rf_source_data),             //        in.data
		.in_valid          (lcd_output_control_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (lcd_output_control_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (lcd_output_control_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (lcd_output_control_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (lcd_output_control_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (lcd_output_control_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (lcd_output_control_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (lcd_output_control_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (lcd_output_control_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) button_exit_s1_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (nios2_processor_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (button_exit_s1_agent_m0_address),                     //              m0.address
		.m0_burstcount           (button_exit_s1_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (button_exit_s1_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (button_exit_s1_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (button_exit_s1_agent_m0_lock),                        //                .lock
		.m0_readdata             (button_exit_s1_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (button_exit_s1_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (button_exit_s1_agent_m0_read),                        //                .read
		.m0_waitrequest          (button_exit_s1_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (button_exit_s1_agent_m0_writedata),                   //                .writedata
		.m0_write                (button_exit_s1_agent_m0_write),                       //                .write
		.rp_endofpacket          (button_exit_s1_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (button_exit_s1_agent_rp_ready),                       //                .ready
		.rp_valid                (button_exit_s1_agent_rp_valid),                       //                .valid
		.rp_data                 (button_exit_s1_agent_rp_data),                        //                .data
		.rp_startofpacket        (button_exit_s1_agent_rp_startofpacket),               //                .startofpacket
		...
		.rf_sink_ready           (button_exit_s1_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (button_exit_s1_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (button_exit_s1_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (button_exit_s1_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (button_exit_s1_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (button_exit_s1_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (button_exit_s1_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (button_exit_s1_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (button_exit_s1_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (button_exit_s1_agent_rf_source_data),                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (button_exit_s1_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (button_exit_s1_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (button_exit_s1_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) button_exit_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (button_exit_s1_agent_rf_source_data),                 //        in.data
		.in_valid          (button_exit_s1_agent_rf_source_valid),                //          .valid
		.in_ready          (button_exit_s1_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (button_exit_s1_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (button_exit_s1_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (button_exit_s1_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (button_exit_s1_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (button_exit_s1_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (button_exit_s1_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (button_exit_s1_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) button_enter_s1_agent (
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (nios2_processor_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (button_enter_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (button_enter_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (button_enter_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (button_enter_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (button_enter_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (button_enter_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (button_enter_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (button_enter_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (button_enter_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (button_enter_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (button_enter_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (button_enter_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (button_enter_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (button_enter_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (button_enter_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (button_enter_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (button_enter_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (button_enter_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (button_enter_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (button_enter_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (button_enter_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (button_enter_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (button_enter_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (button_enter_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (button_enter_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (button_enter_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (button_enter_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (button_enter_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (button_enter_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) button_enter_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (button_enter_s1_agent_rf_source_data),                //        in.data
		.in_valid          (button_enter_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (button_enter_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (button_enter_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (button_enter_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (button_enter_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (button_enter_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (button_enter_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (button_enter_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (button_enter_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (nios2_processor_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (led_b_s1_agent_m0_address),                           //              m0.address
		.m0_burstcount           (led_b_s1_agent_m0_burstcount),                        //                .burstcount
		.m0_byteenable           (led_b_s1_agent_m0_byteenable),                        //                .byteenable
		.m0_debugaccess          (led_b_s1_agent_m0_debugaccess),                       //                .debugaccess
		.m0_lock                 (led_b_s1_agent_m0_lock),                              //                .lock
		.m0_readdata             (led_b_s1_agent_m0_readdata),                          //                .readdata
		.m0_readdatavalid        (led_b_s1_agent_m0_readdatavalid),                     //                .readdatavalid
		.m0_read                 (led_b_s1_agent_m0_read),                              //                .read
		.m0_waitrequest          (led_b_s1_agent_m0_waitrequest),                       //                .waitrequest
		.m0_writedata            (led_b_s1_agent_m0_writedata),                         //                .writedata
		.m0_write                (led_b_s1_agent_m0_write),                             //                .write
		.rp_endofpacket          (led_b_s1_agent_rp_endofpacket),                       //              rp.endofpacket
		.rp_ready                (led_b_s1_agent_rp_ready),                             //                .ready
		.rp_valid                (led_b_s1_agent_rp_valid),                             //                .valid
		.rp_data                 (led_b_s1_agent_rp_data),                              //                .data
		.rp_startofpacket        (led_b_s1_agent_rp_startofpacket),                     //                .startofpacket
		...
		.rf_sink_ready           (led_b_s1_agent_rsp_fifo_out_ready),                   //         rf_sink.ready
		.rf_sink_valid           (led_b_s1_agent_rsp_fifo_out_valid),                   //                .valid
		.rf_sink_startofpacket   (led_b_s1_agent_rsp_fifo_out_startofpacket),           //                .startofpacket
		.rf_sink_endofpacket     (led_b_s1_agent_rsp_fifo_out_endofpacket),             //                .endofpacket
		.rf_sink_data            (led_b_s1_agent_rsp_fifo_out_data),                    //                .data
		.rf_source_ready         (led_b_s1_agent_rf_source_ready),                      //       rf_source.ready
		.rf_source_valid         (led_b_s1_agent_rf_source_valid),                      //                .valid
		.rf_source_startofpacket (led_b_s1_agent_rf_source_startofpacket),              //                .startofpacket
		.rf_source_endofpacket   (led_b_s1_agent_rf_source_endofpacket),                //                .endofpacket
		.rf_source_data          (led_b_s1_agent_rf_source_data),                       //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (led_b_s1_agent_rdata_fifo_src_ready),                 //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_b_s1_agent_rdata_fifo_src_valid),                 //                .valid
		.rdata_fifo_src_data     (led_b_s1_agent_rdata_fifo_src_data),                  //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_b_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (led_b_s1_agent_rf_source_data),                       //        in.data
		.in_valid          (led_b_s1_agent_rf_source_valid),                      //          .valid
		.in_ready          (led_b_s1_agent_rf_source_ready),                      //          .ready
		.in_startofpacket  (led_b_s1_agent_rf_source_startofpacket),              //          .startofpacket
		.in_endofpacket    (led_b_s1_agent_rf_source_endofpacket),                //          .endofpacket
		.out_data          (led_b_s1_agent_rsp_fifo_out_data),                    //       out.data
		.out_valid         (led_b_s1_agent_rsp_fifo_out_valid),                   //          .valid
		.out_ready         (led_b_s1_agent_rsp_fifo_out_ready),                   //          .ready
		.out_startofpacket (led_b_s1_agent_rsp_fifo_out_startofpacket),           //          .startofpacket
		.out_endofpacket   (led_b_s1_agent_rsp_fifo_out_endofpacket),             //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                       //             clk.clk
		.reset                   (nios2_processor_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (uart_main_s1_agent_m0_address),                       //              m0.address
		.m0_burstcount           (uart_main_s1_agent_m0_burstcount),                    //                .burstcount
		.m0_byteenable           (uart_main_s1_agent_m0_byteenable),                    //                .byteenable
		.m0_debugaccess          (uart_main_s1_agent_m0_debugaccess),                   //                .debugaccess
		.m0_lock                 (uart_main_s1_agent_m0_lock),                          //                .lock
		.m0_readdata             (uart_main_s1_agent_m0_readdata),                      //                .readdata
		.m0_readdatavalid        (uart_main_s1_agent_m0_readdatavalid),                 //                .readdatavalid
		.m0_read                 (uart_main_s1_agent_m0_read),                          //                .read
		.m0_waitrequest          (uart_main_s1_agent_m0_waitrequest),                   //                .waitrequest
		.m0_writedata            (uart_main_s1_agent_m0_writedata),                     //                .writedata
		.m0_write                (uart_main_s1_agent_m0_write),                         //                .write
		.rp_endofpacket          (uart_main_s1_agent_rp_endofpacket),                   //              rp.endofpacket
		.rp_ready                (uart_main_s1_agent_rp_ready),                         //                .ready
		.rp_valid                (uart_main_s1_agent_rp_valid),                         //                .valid
		.rp_data                 (uart_main_s1_agent_rp_data),                          //                .data
		.rp_startofpacket        (uart_main_s1_agent_rp_startofpacket),                 //                .startofpacket
		...
		.rf_sink_ready           (uart_main_s1_agent_rsp_fifo_out_ready),               //         rf_sink.ready
		.rf_sink_valid           (uart_main_s1_agent_rsp_fifo_out_valid),               //                .valid
		.rf_sink_startofpacket   (uart_main_s1_agent_rsp_fifo_out_startofpacket),       //                .startofpacket
		.rf_sink_endofpacket     (uart_main_s1_agent_rsp_fifo_out_endofpacket),         //                .endofpacket
		.rf_sink_data            (uart_main_s1_agent_rsp_fifo_out_data),                //                .data
		.rf_source_ready         (uart_main_s1_agent_rf_source_ready),                  //       rf_source.ready
		.rf_source_valid         (uart_main_s1_agent_rf_source_valid),                  //                .valid
		.rf_source_startofpacket (uart_main_s1_agent_rf_source_startofpacket),          //                .startofpacket
		.rf_source_endofpacket   (uart_main_s1_agent_rf_source_endofpacket),            //                .endofpacket
		.rf_source_data          (uart_main_s1_agent_rf_source_data),                   //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_010_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_010_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_010_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_010_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (uart_main_s1_agent_rdata_fifo_src_ready),             //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (uart_main_s1_agent_rdata_fifo_src_valid),             //                .valid
		.rdata_fifo_src_data     (uart_main_s1_agent_rdata_fifo_src_data),              //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) uart_main_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                       //       clk.clk
		.reset             (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (uart_main_s1_agent_rf_source_data),                   //        in.data
		.in_valid          (uart_main_s1_agent_rf_source_valid),                  //          .valid
		.in_ready          (uart_main_s1_agent_rf_source_ready),                  //          .ready
		.in_startofpacket  (uart_main_s1_agent_rf_source_startofpacket),          //          .startofpacket
		.in_endofpacket    (uart_main_s1_agent_rf_source_endofpacket),            //          .endofpacket
		.out_data          (uart_main_s1_agent_rsp_fifo_out_data),                //       out.data
		.out_valid         (uart_main_s1_agent_rsp_fifo_out_valid),               //          .valid
		.out_ready         (uart_main_s1_agent_rsp_fifo_out_ready),               //          .ready
		.out_startofpacket (uart_main_s1_agent_rsp_fifo_out_startofpacket),       //          .startofpacket
		.out_endofpacket   (uart_main_s1_agent_rsp_fifo_out_endofpacket),         //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	main_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (lcd_output_control_slave_agent_rp_ready),             //      sink.ready
		.sink_valid         (lcd_output_control_slave_agent_rp_valid),             //          .valid
		.sink_data          (lcd_output_control_slave_agent_rp_data),              //          .data
		.sink_startofpacket (lcd_output_control_slave_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (lcd_output_control_slave_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_router_002 router_006 (
	...
	main_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (button_exit_s1_agent_rp_ready),                       //      sink.ready
		.sink_valid         (button_exit_s1_agent_rp_valid),                       //          .valid
		.sink_data          (button_exit_s1_agent_rp_data),                        //          .data
		.sink_startofpacket (button_exit_s1_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (button_exit_s1_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (button_enter_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (button_enter_s1_agent_rp_valid),                      //          .valid
		.sink_data          (button_enter_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (button_enter_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (button_enter_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_router_002 router_009 (
	...
	main_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (led_b_s1_agent_rp_ready),                             //      sink.ready
		.sink_valid         (led_b_s1_agent_rp_valid),                             //          .valid
		.sink_data          (led_b_s1_agent_rp_data),                              //          .data
		.sink_startofpacket (led_b_s1_agent_rp_startofpacket),                     //          .startofpacket
		.sink_endofpacket   (led_b_s1_agent_rp_endofpacket),                       //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_router_002 router_011 (
	...
	main_mm_interconnect_0_router_002 router_012 (
		.sink_ready         (uart_main_s1_agent_rp_ready),                         //      sink.ready
		.sink_valid         (uart_main_s1_agent_rp_valid),                         //          .valid
		.sink_data          (uart_main_s1_agent_rp_data),                          //          .data
		.sink_startofpacket (uart_main_s1_agent_rp_startofpacket),                 //          .startofpacket
		.sink_endofpacket   (uart_main_s1_agent_rp_endofpacket),                   //          .endofpacket
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_router_002 router_013 (
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_cmd_mux cmd_mux_011 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_rsp_demux rsp_demux_011 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (nios2_processor_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (lcd_output_control_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (lcd_output_control_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (lcd_output_control_slave_agent_rdata_fifo_src_ready), //         .ready
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (button_exit_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (button_exit_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (button_exit_s1_agent_rdata_fifo_src_ready),           //         .ready
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (button_enter_s1_agent_rdata_fifo_src_data),           //     in_0.data
		.in_0_valid     (button_enter_s1_agent_rdata_fifo_src_valid),          //         .valid
		.in_0_ready     (button_enter_s1_agent_rdata_fifo_src_ready),          //         .ready
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (button_down_s1_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (button_down_s1_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (button_down_s1_agent_rdata_fifo_src_ready),           //         .ready
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_b_s1_agent_rdata_fifo_src_data),                  //     in_0.data
		.in_0_valid     (led_b_s1_agent_rdata_fifo_src_valid),                 //         .valid
		.in_0_ready     (led_b_s1_agent_rdata_fifo_src_ready),                 //         .ready
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (uart_main_s1_agent_rdata_fifo_src_data),              //     in_0.data
		.in_0_valid     (uart_main_s1_agent_rdata_fifo_src_valid),             //         .valid
		.in_0_ready     (uart_main_s1_agent_rdata_fifo_src_ready),             //         .ready
	...
	main_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                       // in_clk_0.clk
		.in_rst_0_reset (nios2_processor_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (button_up_s1_agent_rdata_fifo_src_data),              //     in_0.data
		.in_0_valid     (button_up_s1_agent_rdata_fifo_src_valid),             //         .valid
		.in_0_ready     (button_up_s1_agent_rdata_fifo_src_ready),             //         .ready
